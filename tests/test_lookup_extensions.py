...
class RegexLookupSqliteTest(TestCase):
    def setUp(self):
        super(RegexLookupSqliteTest, self).setUp()
    ...
    def tearDown(self):
        super(RegexLookupSqliteTest, self).tearDown()
        ModelA.objects.all().delete()

    def test_regex(self):
        self.assertEqual(
            1,
            ModelA.objects.filter(name__regex=r'/blog/2017/0./07/kamakura_golden_week/').count(),
        )
        self.assertEqual(
            1,
            ModelA.objects.filter(name__regex=r'/blog/2017/05/07/kamakura_golden_week/*').count(),
        )
        self.assertEqual(
            1,
            ModelA.objects.filter(name__regex=r'/blog/2017/05/07/kamakura_golden_[awe]eek/').count(),
        )
        self.assertEqual(
            1,
            ModelA.objects.filter(name__regex=r'/blog/2017/05/07/kamakura_golden_[^abcd]eek/').count(),
        )
        self.assertEqual(
            1,
            ModelA.objects.filter(name__regex=r'/blog/2017/05/07/kamakura_golden_(week|monthly)/').count(),
        )
        self.assertEqual(
            1,
            ModelA.objects.filter(name__regex=r'/blog/2017/05/07/kamakura_golden_we{2}k/').count(),
        )
        self.assertEqual(
            1,
            ModelA.objects.filter(name__regex=r'/blog/2011/1{1,2}/26/mount_box_net_on_ubuntu/').count(),
        )
        self.assertEqual(
            1,
            ModelA.objects.filter(name__regex=r'/blog/2011/11/26/mount_box_ne\w{2}on_ubuntu/').count(),
        )
        self.assertEqual(
            1,
            ModelA.objects.filter(name__regex=r'/blog/2011/11/26\Wmount_box_net_on_ubuntu/').count(),
        )
        self.assertEqual(
            1,
            ModelA.objects.filter(name__regex=r'/blog/2011/11/2\d/mount_box_net_on_ubuntu/').count(),
        )
        self.assertEqual(
            1,
            ModelA.objects.filter(name__regex=r'/blog/2011/11/26/\Dount_box_net_on_ubuntu/').count(),
        )
        self.assertEqual(
            1,
            ModelA.objects.filter(name__regex=r'I have\shankaku space.').count(),
        )
        self.assertEqual(
            1,
            ModelA.objects.filter(name__regex=r'/blog/2011/11/26/\Sount_box_net_on_ubuntu/').count(),
        )
        self.assertEqual(
            1,
            ModelA.objects.filter(name__regex=r'/blog/2011/11/26/m(o)unt_box_net_on_ubuntu/').count(),
        )
        self.assertEqual(
            1,
            ModelA.objects.filter(name__regex=r'^/blog/2011/11/26/mount_box_net_on_ubuntu/').count(),
        )
        self.assertEqual(
            1,
            ModelA.objects.filter(name__regex='/blog/$').count(),
        )
        self.assertEqual(
            1,
            ModelA.objects.filter(name__regex=r'abc\\ndef\\nf').count(),
        )
        self.assertEqual(
            1,
            ModelA.objects.filter(name__regex=r'got\\ttab').count(),
        )
        self.assertEqual(
            1,
            ModelA.objects.filter(name__regex=r'hello\s+a').count(),
        )
        self.assertEqual(
            1,
            ModelA.objects.filter(name__regex=r'I \w').count(),
        )
        # case sensitive
        self.assertEqual(
            0,
    ...
    def test_regex_unsupported(self):
        self.assertEqual(
            0,
            ModelA.objects.filter(name__regex=r'\<hankaku').count(),
        )
        self.assertEqual(
            0,
            ModelA.objects.filter(name__regex=r'\<ankaku').count(),
        )
        self.assertEqual(
            0,
            ModelA.objects.filter(name__regex=r'hankaku\>').count(),
        ...
        self.assertEqual(
            0,
            ModelA.objects.filter(name__regex=r'hankak\>').count(),
        )

    def test_iregex(self):
        self.assertEqual(
            1,
            ModelA.objects.filter(name__iregex=r'/Blog/2017/0./07/kamakura_golden_week/').count(),
        )
        self.assertEqual(
            1,
            ModelA.objects.filter(name__iregex=r'/Blog/2017/05/07/kamakura_golden_week/*').count(),
        )
        self.assertEqual(
            1,
            ModelA.objects.filter(name__iregex=r'/Blog/2017/05/07/kamakura_golden_[awe]eek/').count(),
        )
        self.assertEqual(
            1,
            ModelA.objects.filter(name__iregex=r'/Blog/2017/05/07/kamakura_golden_[^abcd]eek/').count(),
        )
        self.assertEqual(
            1,
            ModelA.objects.filter(name__iregex=r'/Blog/2017/05/07/kamakura_golden_(week|monthly)/').count(),
        )
        self.assertEqual(
            1,
            ModelA.objects.filter(name__iregex=r'/Blog/2017/05/07/kamakura_golden_we{2}k/').count(),
        )
        self.assertEqual(
            1,
            ModelA.objects.filter(name__iregex=r'/Blog/2011/1{1,2}/26/mount_box_net_on_ubuntu/').count(),
        )
        self.assertEqual(
            1,
            ModelA.objects.filter(name__iregex=r'/Blog/2011/11/26/mount_box_ne\w{2}on_ubuntu/').count(),
        )
        self.assertEqual(
            1,
            ModelA.objects.filter(name__iregex=r'/Blog/2011/11/26\Wmount_box_net_on_ubuntu/').count(),
        )
        self.assertEqual(
            1,
            ModelA.objects.filter(name__iregex=r'/Blog/2011/11/2\d/mount_box_net_on_ubuntu/').count(),
        )
        self.assertEqual(
            1,
            ModelA.objects.filter(name__iregex=r'/Blog/2011/11/26/\Dount_box_net_on_ubuntu/').count(),
        )
        self.assertEqual(
            1,
            ModelA.objects.filter(name__iregex=r'i HAVE\shankaku space.').count(),
        )
        self.assertEqual(
            1,
            ModelA.objects.filter(name__iregex=r'/Blog/2011/11/26/\Sount_box_net_on_ubuntu/').count(),
        )
        self.assertEqual(
            1,
            ModelA.objects.filter(name__iregex=r'/Blog/2011/11/26/m(o)unt_box_net_on_ubuntu/').count(),
        )
        self.assertEqual(
            1,
            ModelA.objects.filter(name__iregex=r'^/Blog/2011/11/26/mount_box_net_on_ubuntu/').count(),
        )
        self.assertEqual(
            1,
            ModelA.objects.filter(name__iregex='/Blog/$').count(),
        )
        self.assertEqual(
            1,
            ModelA.objects.filter(name__iregex=r'Abc\\nDef\\nf').count(),
        )
        self.assertEqual(
            1,
            ModelA.objects.filter(name__iregex=r'Got\\tTab').count(),
        )
        self.assertEqual(
            1,
            ModelA.objects.filter(name__iregex=r'Hello\s+a').count(),
        )
        self.assertEqual(
            1,
            ModelA.objects.filter(name__iregex=r'i \w').count(),
        )

    def test_iregex_unsupported(self):
        self.assertEqual(
            0,
            ModelA.objects.filter(name__iregex=r'\<Hankaku').count(),
        )
        self.assertEqual(
            0,
            ModelA.objects.filter(name__iregex=r'\<Ankaku').count(),
        )
        self.assertEqual(
            0,
            ModelA.objects.filter(name__iregex=r'Hankaku\>').count(),
        ...
        self.assertEqual(
            0,
            ModelA.objects.filter(name__iregex=r'Hankak\>').count(),
        )

    def test_regex_sql_injection(self):
        self.assertEqual(
            0,
            ModelA.objects.filter(name__regex="' or 'A'='A").count(),
        )

    def test_neregex(self):
        self.assertEqual(
            8,
            ModelA.objects.filter(name__neregex=r'/blog/2017/0./07/kamakura_golden_week/').count(),
        )
        self.assertEqual(
            8,
            ModelA.objects.filter(name__neregex=r'/blog/2017/05/07/kamakura_golden_week/*').count(),
        )
        self.assertEqual(
            8,
            ModelA.objects.filter(name__neregex=r'/blog/2017/05/07/kamakura_golden_[awe]eek/').count(),
        )
        self.assertEqual(
            8,
            ModelA.objects.filter(name__neregex=r'/blog/2017/05/07/kamakura_golden_[^abcd]eek/').count(),
        )
        self.assertEqual(
            8,
            ModelA.objects.filter(name__neregex=r'/blog/2017/05/07/kamakura_golden_(week|monthly)/').count(),
        )
        self.assertEqual(
            8,
            ModelA.objects.filter(name__neregex=r'/blog/2017/05/07/kamakura_golden_we{2}k/').count(),
        )
        self.assertEqual(
            8,
            ModelA.objects.filter(name__neregex=r'/blog/2011/1{1,2}/26/mount_box_net_on_ubuntu/').count(),
        )
        self.assertEqual(
            8,
            ModelA.objects.filter(name__neregex=r'/blog/2011/11/26/mount_box_ne\w{2}on_ubuntu/').count(),
        )
        self.assertEqual(
            8,
            ModelA.objects.filter(name__neregex=r'/blog/2011/11/26\Wmount_box_net_on_ubuntu/').count(),
        )
        self.assertEqual(
            8,
            ModelA.objects.filter(name__neregex=r'/blog/2011/11/2\d/mount_box_net_on_ubuntu/').count(),
        )
        self.assertEqual(
            8,
            ModelA.objects.filter(name__neregex=r'/blog/2011/11/26/\Dount_box_net_on_ubuntu/').count(),
        )
        self.assertEqual(
            8,
            ModelA.objects.filter(name__neregex=r'I have\shankaku space.').count(),
        )
        self.assertEqual(
            8,
            ModelA.objects.filter(name__neregex=r'/blog/2011/11/26/\Sount_box_net_on_ubuntu/').count(),
        )
        self.assertEqual(
            8,
            ModelA.objects.filter(name__neregex=r'/blog/2011/11/26/m(o)unt_box_net_on_ubuntu/').count(),
        )
        self.assertEqual(
            8,
            ModelA.objects.filter(name__neregex=r'^/blog/2011/11/26/mount_box_net_on_ubuntu/').count(),
        )
        self.assertEqual(
            8,
            ModelA.objects.filter(name__neregex='/blog/$').count(),
        )
        self.assertEqual(
            8,
            ModelA.objects.filter(name__neregex=r'abc\\ndef\\nf').count(),
        )
        self.assertEqual(
            8,
            ModelA.objects.filter(name__neregex=r'got\\ttab').count(),
        )
        self.assertEqual(
            8,
            ModelA.objects.filter(name__neregex=r'hello\s+a').count(),
        )
        self.assertEqual(
            8,
            ModelA.objects.filter(name__neregex=r'I \w').count(),
        )
        #  {1,2}? errors (1139, "Got error 'repetition-operator operand invalid' from regexp")

    def test_neregex_unsupported(self):
        self.assertEqual(
            9,
            ModelA.objects.filter(name__neregex=r'\<hankaku').count(),
        )
        self.assertEqual(
            9,
            ModelA.objects.filter(name__neregex=r'\<ankaku').count(),
        )
        self.assertEqual(
            9,
            ModelA.objects.filter(name__neregex=r'hankaku\>').count(),
        ...
        self.assertEqual(
            9,
            ModelA.objects.filter(name__neregex=r'hankak\>').count(),
        )

    def test_neiregex(self):
        self.assertEqual(
            8,
            ModelA.objects.filter(name__neiregex=r'/Blog/2017/0./07/kamakura_golden_week/').count(),
        )
        self.assertEqual(
            8,
            ModelA.objects.filter(name__neiregex=r'/Blog/2017/05/07/kamakura_golden_week/*').count(),
        )
        self.assertEqual(
            8,
            ModelA.objects.filter(name__neiregex=r'/Blog/2017/05/07/kamakura_golden_[awe]eek/').count(),
        )
        self.assertEqual(
            8,
            ModelA.objects.filter(name__neiregex=r'/Blog/2017/05/07/kamakura_golden_[^abcd]eek/').count(),
        )
        self.assertEqual(
            8,
            ModelA.objects.filter(name__neiregex=r'/Blog/2017/05/07/kamakura_golden_(week|monthly)/').count(),
        )
        self.assertEqual(
            8,
            ModelA.objects.filter(name__neiregex=r'/Blog/2017/05/07/kamakura_golden_we{2}k/').count(),
        )
        self.assertEqual(
            8,
            ModelA.objects.filter(name__neiregex=r'/Blog/2011/1{1,2}/26/mount_box_net_on_ubuntu/').count(),
        )
        self.assertEqual(
            8,
            ModelA.objects.filter(name__neiregex=r'/Blog/2011/11/26/mount_box_ne\w{2}on_ubuntu/').count(),
        )
        self.assertEqual(
            8,
            ModelA.objects.filter(name__neiregex=r'/Blog/2011/11/26\Wmount_box_net_on_ubuntu/').count(),
        )
        self.assertEqual(
            8,
            ModelA.objects.filter(name__neiregex=r'/Blog/2011/11/2\d/mount_box_net_on_ubuntu/').count(),
        )
        self.assertEqual(
            8,
            ModelA.objects.filter(name__neiregex=r'/Blog/2011/11/26/\Dount_box_net_on_ubuntu/').count(),
        )
        self.assertEqual(
            8,
            ModelA.objects.filter(name__neiregex=r'i HAVE\shankaku space.').count(),
        )
        self.assertEqual(
            8,
            ModelA.objects.filter(name__neiregex=r'/Blog/2011/11/26/\Sount_box_net_on_ubuntu/').count(),
        )
        self.assertEqual(
            8,
            ModelA.objects.filter(name__neiregex=r'/Blog/2011/11/26/m(o)unt_box_net_on_ubuntu/').count(),
        )
        self.assertEqual(
            8,
            ModelA.objects.filter(name__neiregex=r'^/Blog/2011/11/26/mount_box_net_on_ubuntu/').count(),
        )
        self.assertEqual(
            8,
            ModelA.objects.filter(name__neiregex='/Blog/$').count(),
        )
        self.assertEqual(
            8,
            ModelA.objects.filter(name__neiregex=r'Abc\\nDef\\nf').count(),
        )
        self.assertEqual(
            8,
            ModelA.objects.filter(name__neiregex=r'Got\\tTab').count(),
        )
        self.assertEqual(
            8,
            ModelA.objects.filter(name__neiregex=r'Hello\s+a').count(),
        )
        self.assertEqual(
            8,
            ModelA.objects.filter(name__neiregex=r'i \w').count(),
        )

    def test_neiregex_unsupported(self):
        self.assertEqual(
            9,
            ModelA.objects.filter(name__neiregex=r'\<Hankaku').count(),
        )
        self.assertEqual(
            9,
            ModelA.objects.filter(name__neiregex=r'\<Ankaku').count(),
        )
        self.assertEqual(
            9,
            ModelA.objects.filter(name__neiregex=r'Hankaku\>').count(),
        ...
        self.assertEqual(
            9,
            ModelA.objects.filter(name__neiregex=r'Hankak\>').count(),
        )
...
class RegexLookupMySQLTest(TestCase):
    ...
    def test_regex(self):
        ...
        self.assertEqual(
            1,
            ModelMySQLA.objects.filter(name__regex=r'/blog/2011/11/26/mount_box_ne[[:alnum:]_]{2}on_ubuntu/').count(),
        )
        self.assertEqual(
            1,
            ModelMySQLA.objects.filter(name__regex=r'/blog/2011/11/26[^[:alnum:]_]mount_box_net_on_ubuntu/').count(),
        )
        self.assertEqual(
            1,
            ModelMySQLA.objects.filter(name__regex=r'/blog/2011/11/2[[:digit:]]/mount_box_net_on_ubuntu/').count(),
        )
        self.assertEqual(
            1,
            ModelMySQLA.objects.filter(name__regex=r'/blog/2011/11/26/[^[:digit:]]ount_box_net_on_ubuntu/').count(),
        )
        self.assertEqual(
            1,
            ModelMySQLA.objects.filter(name__regex=r'I have[[:space:]]hankaku space.').count(),
        )
        self.assertEqual(
            1,
            ModelMySQLA.objects.filter(name__regex=r'/blog/2011/11/26/[^[:space:]]ount_box_net_on_ubuntu/').count(),
        )
        self.assertEqual(
            1,
        ...
        self.assertEqual(
            1,
            ModelMySQLA.objects.filter(name__regex=r'hello[[:space:]]+a').count(),
        )
        self.assertEqual(
            1,
        ...
        self.assertEqual(
            1,
            ModelMySQLA.objects.filter(name__regex=r'I [[:alnum:]_]').count(),
        )
        # case sensitive
        self.assertEqual(
            0,
    ...
    def test_iregex(self):
        ...
        self.assertEqual(
            1,
            ModelMySQLA.objects.filter(name__iregex=r'/Blog/2011/11/26/mount_box_ne[[:alnum:]_]{2}on_ubuntu/').count(),
        )
        self.assertEqual(
            1,
            ModelMySQLA.objects.filter(name__iregex=r'/Blog/2011/11/26[^[:alnum:]_]mount_box_net_on_ubuntu/').count(),
        )
        self.assertEqual(
            1,
            ModelMySQLA.objects.filter(name__iregex=r'/Blog/2011/11/2[[:digit:]]/mount_box_net_on_ubuntu/').count(),
        )
        self.assertEqual(
            1,
            ModelMySQLA.objects.filter(name__iregex=r'/Blog/2011/11/26/[^[:digit:]]ount_box_net_on_ubuntu/').count(),
        )
        self.assertEqual(
            1,
            ModelMySQLA.objects.filter(name__iregex=r'i HAVE[[:space:]]hankaku space.').count(),
        )
        self.assertEqual(
            1,
            ModelMySQLA.objects.filter(name__iregex=r'/Blog/2011/11/26/[^[:space:]]ount_box_net_on_ubuntu/').count(),
        )
        self.assertEqual(
            1,
        ...
        self.assertEqual(
            1,
            ModelMySQLA.objects.filter(name__iregex=r'Hello[[:space:]]+a').count(),
        )
        self.assertEqual(
            1,
        ...
        self.assertEqual(
            1,
            ModelMySQLA.objects.filter(name__iregex=r'i [[:alnum:]_]').count(),
        )
    ...
    def test_neregex(self):
        ...
        self.assertEqual(
            8,
            ModelMySQLA.objects.filter(name__neregex=r'/blog/2011/11/26/mount_box_ne[[:alnum:]_]{2}on_ubuntu/').count(),
        )
        self.assertEqual(
            8,
            ModelMySQLA.objects.filter(name__neregex=r'/blog/2011/11/26[^[:alnum:]_]mount_box_net_on_ubuntu/').count(),
        )
        self.assertEqual(
            8,
            ModelMySQLA.objects.filter(name__neregex=r'/blog/2011/11/2[[:digit:]]/mount_box_net_on_ubuntu/').count(),
        )
        self.assertEqual(
            8,
            ModelMySQLA.objects.filter(name__neregex=r'/blog/2011/11/26/[^[:digit:]]ount_box_net_on_ubuntu/').count(),
        )
        self.assertEqual(
            8,
            ModelMySQLA.objects.filter(name__neregex=r'I have[[:space:]]hankaku space.').count(),
        )
        self.assertEqual(
            8,
            ModelMySQLA.objects.filter(name__neregex=r'/blog/2011/11/26/[^[:space:]]ount_box_net_on_ubuntu/').count(),
        )
        self.assertEqual(
            8,
        ...
        self.assertEqual(
            8,
            ModelMySQLA.objects.filter(name__neregex=r'hello[[:space:]]+a').count(),
        )
        self.assertEqual(
            8,
        ...
        self.assertEqual(
            8,
            ModelMySQLA.objects.filter(name__neregex=r'I [[:alnum:]_]').count(),
        )
        #  {1,2}? errors (1139, "Got error 'repetition-operator operand invalid' from regexp")
    ...
    def test_neiregex(self):
        ...
        self.assertEqual(
            8,
            ModelMySQLA.objects.filter(name__neiregex=r'/Blog/2011/11/26[^[:alnum:]_]mount_box_net_on_ubuntu/').count(),
        )
        self.assertEqual(
            8,
            ModelMySQLA.objects.filter(name__neiregex=r'/Blog/2011/11/2[[:digit:]]/mount_box_net_on_ubuntu/').count(),
        )
        self.assertEqual(
            8,
            ModelMySQLA.objects.filter(name__neiregex=r'/Blog/2011/11/26/[^[:digit:]]ount_box_net_on_ubuntu/').count(),
        )
        self.assertEqual(
            8,
            ModelMySQLA.objects.filter(name__neiregex=r'i HAVE[[:space:]]hankaku space.').count(),
        )
        self.assertEqual(
            8,
            ModelMySQLA.objects.filter(name__neiregex=r'/Blog/2011/11/26/[^[:space:]]ount_box_net_on_ubuntu/').count(),
        )
        self.assertEqual(
            8,
        ...
        self.assertEqual(
            8,
            ModelMySQLA.objects.filter(name__neiregex=r'Hello[[:space:]]+a').count(),
        )
        self.assertEqual(
            8,
        ...
        self.assertEqual(
            8,
            ModelMySQLA.objects.filter(name__neiregex=r'i [[:alnum:]_]').count(),
        )
